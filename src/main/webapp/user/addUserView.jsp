...
<script type="text/javascript">
	function fncAddUser() {
		...
		var here = $( ".ct_write01 td:nth-child(1)" ).text();
	...
	$(function() {
		$( ".ct_write01 td:nth-child(1)" ).css("color" , "red");
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="105"><input type="text" name="userId"
								class="ct_input_bg" id="userId"
								style="width: 100px; height: 19px" maxLength="20"></td>
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										</td>
										<td class="ct_write01" id ="here"></td>
									</tr>
								</table>
							</td>
						</tr>
			...
			<tr>
				...
				<td class="ct_write01">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="26"><input type="text" name="email"
								class="ct_input_g" style="width: 100px; height: 19px" /></td>
						</tr>
					</table>
				</td>
			</tr>
